...
public class UserCreated extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8585362862397220255L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserCreated\",\"namespace\":\"com.example.avro\",\"fields\":[{\"name\":\"userId\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"}]}");
   ...
   */
  public UserCreated(java.lang.CharSequence userId, java.lang.CharSequence email) {
    this.userId = userId;
    this.email = email;
  }
   ...
   */
  public static com.example.avro.UserCreated.Builder newBuilder() {
    return new com.example.avro.UserCreated.Builder();
  }
   ...
   * @return A new UserCreated RecordBuilder
   */
  public static com.example.avro.UserCreated.Builder newBuilder(com.example.avro.UserCreated.Builder other) {
    if (other == null) {
      return new com.example.avro.UserCreated.Builder();
    } else {
      return new com.example.avro.UserCreated.Builder(other);
    }
  }
   ...
   * @return A new UserCreated RecordBuilder
   */
  public static com.example.avro.UserCreated.Builder newBuilder(com.example.avro.UserCreated other) {
    if (other == null) {
      return new com.example.avro.UserCreated.Builder();
    } else {
      return new com.example.avro.UserCreated.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserCreated>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.avro.UserCreated.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.avro.UserCreated other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.UserCreated.Builder setUserId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.UserCreated.Builder clearUserId() {
      userId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.UserCreated.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.UserCreated.Builder clearEmail() {
      email = null;
  ...
  public boolean equals(Object o) {
    ...
    UserCreated other = (UserCreated) o;
